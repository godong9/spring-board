...
CREATE TABLE IF NOT EXISTS `board`.`posts` (
  ...
  `post_unlike_count` BIGINT NOT NULL DEFAULT 0,
  ...
  INDEX `idx_stock_id_on_posts` (`stock_id` ASC))
ENGINE = InnoDB
AUTO_INCREMENT = 2
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `board`.`user_roles` (
  ...
  INDEX `idx_role_exp_on_user_roles` (`expired_at` ASC, `role` ASC))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `board`.`post_likes` (
  ...
  INDEX `idx_unlike_on_post_likes` (`unlike` ASC))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `board`.`companies` (
  ...
  INDEX `idx_company_mail_on_companies` (`company_mail` ASC))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `board`.`post_reports` (
  ...
  `updated_at` DATETIME NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `idx_post_id_user_id_on_post_reports` (`post_id` ASC, `user_id` ASC))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `board`.`payments`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `board`.`payments` ;

CREATE TABLE IF NOT EXISTS `board`.`payments` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` DATETIME NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `idx_user_id_on_payments` (`user_id` ASC))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `board`.`payment_infos`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `board`.`payment_infos` ;

CREATE TABLE IF NOT EXISTS `board`.`payment_infos` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `customer_uid` VARCHAR(10) NOT NULL,
...
-- -----------------------------------------------------
-- Table `board`.`payment_results`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `board`.`payment_results` ;

CREATE TABLE IF NOT EXISTS `board`.`payment_results` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `code` INT NOT NULL,
  `amount` DOUBLE NULL,
  ...
  `updated_at` DATETIME NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `idx_payment_id_on_payment_results` (`payment_id` ASC))
ENGINE = InnoDB;
